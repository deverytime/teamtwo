...
<body class="bg-slate-50 text-slate-800">
	...
	<main class="page-wrap">
		...
		<div class="mb-8">
			...
			<hr>
			<br>
			<button class="btn btn-soft-brand" onclick="location.href='list.do?board=${board}';">돌아가기</button>
		</div>
			      ...
			      <div class="content-card overflow-hidden">
			        ...
			        <div class="card-pad">
					  ...
					  <div>
						  ...
						  <button type="button" class="btn btn-soft-brand mt-2" onclick="addFile()">+ 파일 추가</button>
						</div>
					  </div>
					</div>
